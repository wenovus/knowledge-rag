...
class GraphLLMPromptTuning(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if args.llm_model_name == "gemma_7b":
            output_channels = 3072
        elif args.llm_model_name == "1b":
    ...
    def forward(self, samples):
        ...
        for i in range(batch_size):
            ...
            inputs_embeds = torch.cat([bos_embeds, prompt_embeds, graph_embeds[i].unsqueeze(0), inputs_embeds], dim=0)
